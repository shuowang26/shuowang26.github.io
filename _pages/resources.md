...
<table>
	<tr>
	    ...
	    <td width="60%"><p markdown="1">**Eye-tracking Dataset of Endoscopist-AI Teaming (EndoGaze)**<br>
      [[code](https://github.com/ku262/EndoGaze)] [[dataset](https://www.scidb.cn/s/2ERFNf)] [[paper](https://www.nature.com/articles/s41597-025-04535-6)]<br>
			The EndoGaze dataset can be used to analyze changes in endoscopists’ eye movements during the colonoscopy withdrawal phase.
      </p></td>
	</tr>
</table>
<table>
	<tr>
	    <td width="40%"><img  src="{{ base_path }}/images/dataset-FPPD13.png"></td>
...
<table>
	<tr>
	    <td width="40%"><img  src="{{ base_path }}/images/challenge-CMRxMotion22.gif"></td>
	...
	<tr>
			<td width="40%" align="center"><img  src="{{ base_path }}/images/challenge-CMRxRecon23.jpeg" style="width: 50%"></td>
	...
	<tr>
			<td width="40%" align="center"><img  src="{{ base_path }}/images/challenge-CMRxRecon24.png" style="width: 50%"></td>
